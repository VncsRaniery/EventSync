...
export const CARDS = [
    {
        Icon: Link2Icon,
        name: "Criar eventos",
        description: "Crie eventos e os compartilhe com outros usuários na nossa plataforma.",
        href: "#",
        cta: "Leia mais",
        ...
        background: (
            <Card className="absolute top-10 left-10 origin-top rounded-none rounded-tl-md transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105 border border-border border-r-0">
                <CardHeader>
                    ...
                    <CardDescription>
                    Crie eventos e os compartilhe com outros usuários na nossa plataforma.
                    </CardDescription>
                </CardHeader>
    ...
    {
        Icon: SearchIcon,
        name: "Pesquise seus eventos",
        description: "Encontre rapidamente os eventos que você quer com a pesquisa baseada em categorias.",
        href: "#",
        cta: "Leia mais",
        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                ...
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Tecnologia</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Workshops</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Networking</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Palestras</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Confraternizações</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Maratonas</div>
                </div>
            </Command>
        ),
    },
    {
        Icon: WaypointsIcon,
        name: "Conecte seus aplicativos",
        description: "Em breve integre com seus aplicativos e serviços favoritos.",
        href: "#",
        cta: "Leia mais",
    ...
    },
    {
        Icon: CalendarIcon,
        name: "Calendário",
        description: "Acompanhe seus eventos com nossa visualização de calendário.",
        className: "col-span-3 lg:col-span-1",
        href: "#",
        cta: "Leia mais",
        background: (
